...
## 🛡️ اسکریپت‌ها و ابزارهای هک اتیکال

> ⚠️ **هشدار:** تمامی اسکریپت‌های زیر صرفاً برای **آموزش و تست نفوذ قانونی** طراحی شده‌اند. استفاده غیرمجاز از آن‌ها غیرقانونی است و مسئولیت آن بر عهده کاربر می‌باشد.

| اسکریپت | توضیحات | زبان |
|---------|---------|------|
| 🔍 `recon-tool` | جمع‌آوری اطلاعات و اسکن اولیه شبکه | Python |
| 🌐 `web-scanner` | اسکنر آسیب‌پذیری‌های وب | Python |
| 🔐 `hash-cracker` | کرک هش‌ها با دیکشنری | C# |
| 📡 `net-automation` | اتوماسیون تسک‌های شبکه | Bash |
| 🖥️ `sys-info` | جمع‌آوری اطلاعات سیستم | Batch |

*(به‌زودی ریپازیتوری‌های اختصاصی هر کدوم رو منتشر می‌کنم!)*
...
<img src="https://github-readme-stats.vercel.app/api?username=AmirabbasDorasay&show_icons=true&theme=radical&hide_border=true&include_all_commits=true&count_private=true" width="48%" />
<img src="https://github-readme-streak-stats.herokuapp.com/?user=AmirabbasDorasay&theme=radical&hide_border=true" width="48%" />

<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=AmirabbasDorasay&layout=compact&theme=radical&hide_border=true" width="60%" />
...
**⭐ اگه پروژه‌هام به کارت اومد، حتماً ستاره بده!**

![Visitor Count](https://komarev.com/ghpvc/?username=AmirabbasDorasay&color=00FF41&style=flat-square&label=PROFILE+VIEWS)
